"""
Django settings for Tennis_ML_Predictor project.
...
SECRET_KEY = 'django-insecure-o*efl^z@b%e5g#*y%+21(9zo8=@pf!(15e-=j@7i_sla*v_h!s'
...
WSGI_APPLICATION = 'Tennis_ML_Predictor.wsgi.application'
